...
export default function RsvpForm({ name, themeColor }: RsvpFormProps) {
  ...
  const accentBorderClass =
    themeColor === "rockstar-pink"
      ? "border-slate-950 shadow-[6px_6px_0px_#FF4FA3]"
      : themeColor === "retro-purple"
        ? "border-slate-950 shadow-[6px_6px_0px_#6A00F4]"
        : themeColor === "cyber-cyan"
          ? "border-slate-950 shadow-[6px_6px_0px_#00D9FF]"
  ...
  const btnColorClass =
    themeColor === "rockstar-pink"
      ? "bg-[#FF4FA3] hover:bg-[#FF4FA3]/90 text-white"
      : themeColor === "retro-purple"
        ? "bg-[#6A00F4] hover:bg-[#6A00F4]/90 text-white"
        : themeColor === "cyber-cyan"
          ? "bg-[#00D9FF] text-slate-950 hover:bg-[#00D9FF]/90 font-black"
          : themeColor === "sweet-peach"
            ? "bg-[#FF4FA3] text-slate-950 hover:bg-[#FF4FA3]/90 font-black"
      ...
      {/* <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 relative z-20 pb-16">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white border-3 border-slate-950 text-xs font-mono font-black tracking-widest text-slate-800 uppercase shadow-[3px_3px_0px_#121212]">
            <Mail className="w-3.5 h-3.5 text-[#FF4FA3]" /> Virtual Attendance
            Sheet
          </div>
          ...
          <p className="text-xs text-slate-850 font-medium max-w-sm mx-auto">
            Are you joining the virtual concert bash? Leave your status and a
            quick congrats note for {name}!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center justify-between max-w-5xl mx-auto pt-4">
          ...
          <div
            className={`lg:col-span-7 bg-white border-4 border-slate-950 rounded-3xl p-6 sm:p-8 ${accentBorderClass} relative`}
          >
            {!submitted ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {[
                      {
                        id: "stagedive",
                        label: "🤘 Heck yeah, Stage-dive!",
                        desc: "I am ready to rock.",
                      },
                      {
                        id: "wishes",
                        label: "🍕 Send Pizza & Wishes",
                        desc: "Joining online!",
                      },
                      {
                        id: "lazy",
                        label: "🍿 Just Lurking Lazy",
                        desc: "Silently watching!",
                      },
                    ].map((opt) => (
                      <div
                        key={opt.id}
              ...
              <div className="text-center py-12 space-y-4 animate-fade-in">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-800 font-mono font-bold mt-1.5">
                    Your attendance:{" "}
                    <span className="text-slate-950 font-black uppercase bg-[#FFD93D] px-1 py-0.5 border border-slate-950 rounded-md">
                      {choice === "stagedive"
                        ? "Stage-dive"
                        : choice === "wishes"
                          ? "Send Pizza"
                ...
                <p className="text-xs text-slate-800 font-bold max-w-sm mx-auto leading-relaxed">
                  Thanks,{" "}
                  <span className="font-extrabold text-[#FF4FA3]">
                    {rsvpName}
                  </span>
                  ! Your attendance checklist has been registered. Get ready for
                  an absolute blast of an hour under the lasers!
                </p>
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col justify-center">
            <div className="bg-white border-4 border-slate-950 p-5 rounded-3xl relative overflow-hidden select-none space-y-4 shadow-[4px_4px_0px_#121212] pr-4">
              <span className="text-5xl absolute right-2 bottom-2 opacity-10">
                🎫
              </span>
              ...
              <div className="space-y-4 font-sans pt-1">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="text-left space-y-0.5">
                    <span className="block text-[9px] font-mono text-slate-700 uppercase font-black leading-none">
                      WHERE?
                    </span>
                    <span className="block text-xs text-slate-950 font-black">
                      The Great Neon Backstage Lounge
                    </span>
                    <span className="block text-[10px] text-slate-705 leading-tight font-bold">
                      Virtual Cloud Run Web, Suite 3000
                    </span>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="text-left space-y-0.5">
                    ...
                    <span className="block text-xs text-slate-950 font-black">
                      Glitter Rockstar Custom Sticker Caps
                    </span>
                    <span className="block text-[10px] text-slate-705 leading-tight font-bold">
                      Comfortable for massive headbanging!
                    </span>
                  </div>
                </div>
              </div>
            ...
            <p className="text-[10px] text-slate-600 font-mono font-black leading-relaxed pl-1 uppercase tracking-wider">
              * Note: The digital wishing deck gathers automatically and streams
              updates live inside local context state!
            </p>
          </div>
        </div>
      </div> */}
